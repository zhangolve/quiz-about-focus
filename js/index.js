...
$(function(){
    ...
    .ajaxStart(function () {  //https://api.jquery.com/ajaxStart/
        ...
        var score=0;
        var clickNum=0;
        var allQuestion=['你有多常忘记约会或应做的事？','你有多常在家里或单位将东西随手一放然后又找不到了？','要做一件费心思考的工作时，你有多常逃避或拖延去做？','要执行一个枯燥或困难的计划时，你有多常因粗心而犯错？','做枯燥而重复的工作时，你多常体验到难以持续专注？','跟别人说话时，你多常感到难以专注听清对方和你讲的内容？','一旦完成计划中最富挑战的部分你多常感动很难把收尾细节做好？','你有多常觉得很难井然有序地做一个需要好好组织规划的任务？','你有多常因为身边的活动或声音而分心？'];
